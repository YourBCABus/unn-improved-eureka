...
pub async fn add_teacher_associated_oauth(
    ...
    use crate::queries::teacher::add_teacher_oauth as add_teacher_associated_oauth_in_db;
...
pub async fn remove_teacher_associated_oauth(
    ...
    use crate::queries::teacher::remove_teacher_oauth as remove_teacher_associated_oauth_in_db;
    use crate::queries::teacher::get_teacher as get_teacher_from_db;
