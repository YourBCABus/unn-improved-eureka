...
CREATE TABLE public.periods (
    ...
    UtcStartDefault time without time zone DEFAULT '00:00:00'::time without time zone NOT NULL,
    UtcEndDefault time without time zone DEFAULT '00:00:00'::time without time zone NOT NULL,
    
    UtcStartCurrent time without time zone NULL,
    UtcEndCurrent time without time zone NULL
);
...
CREATE TABLE public.teachers (
    ...
    honorific character varying(255) NOT NULL,
